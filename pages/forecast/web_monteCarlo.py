...
class The_Monte_Carlo(object):
    ...
    #     *     *     *     *     *     *     *     *     *     *     *     *     *     *     *     *     *     *     *     *
        ...
        #     *     plotting    *     *     *     *     *     *     *     *     *     *     *     *     *     *     *
            ...
            self.stock = st.text_input('Please Enter Stock Ticker To Model:')
            if self.stock:
        ...
        #     *     *     *     *     *     *     *     *     *     *     *     *     *     *     *     *     *     *     *     *
                ...
                first_test_date = test.index[0].date()
                last_test_date = test.index[-1].date()
                plot_title = (f'{self.company} ({self.stock}) - Monte Carlo Simulation ' f'({a} - {today})')
                selected_indices = adj_close[last_train_date:last_test_date].index
                index = [date.date() for date in selected_indices]
                gbm_simulations_df = pd.DataFrame(np.transpose(gbm_simulations), index=index)
            #     *     plotting    *     *     *     *     *     *     *     *     *     *     *     *     *     *     *
                ...
                line_1, = ax.plot(index, gbm_simulations_df.mean(axis=1), color='red')
                line_2, = ax.plot(index, adj_close[last_train_date:last_test_date], color='blue')
                ax.set_title(f"{self.company} ({self.stock}) - Monte Carlo Simulation", fontsize=16)
                ax.legend((line_1, line_2), ('mean-price', 'actual-price'), loc='best')
                plt.xlabel('Test Date Range')
                plt.ylabel('Stock Price')
                plt.tight_layout()
                plt.grid(which='major', axis='both')
