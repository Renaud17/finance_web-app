...
class Analize_Portfolio(object):
    ...
    def situation(self):
        ...
        def simulate_returns(historical_returns,forecast_days):
            return historical_returns.sample(
            n=forecast_days, replace = True).reset_index(drop = True)
...
if __name__ == '__main__':
    my_positions = pd.read_pickle('/home/gordon/gdp/code/portfolio/Market_Mapping/files/tickers/chuck_merged_ticker_lst.pkl')
