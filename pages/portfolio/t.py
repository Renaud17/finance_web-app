...
class Recommendations1(object):
    ...
    for ticker in tickers:
        ...
        # st.write("--------------------------------------------")
        # st.write("{} has an average recommendation of: ".format(ticker), recommendation)
        #time.sleep(0.5)
    ...
    rslt_df = dataframe[dataframe['Recommendations'] < 2.5]
    st.title('Analyst Recommendations')
    st.dataframe(rslt_df)
    recomendation_ticker_list = list(rslt_df.index)
    # st.write(recomendation_ticker_list)
...
class Recommendations2(object):
    ...
    rating_ticker_list = list(exportList.index)
    st.write(rating_ticker_list)
    # return rating_ticker_list
