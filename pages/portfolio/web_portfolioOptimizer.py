...
# #* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
        ...
        # PLOT * * * 
            ...
            plt.title(f'{self.saveName0} - Simulated Portfolio Optimization based on Efficient Frontier', fontsize=30, fontweight='bold')
...
# #* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
        ...
        # PLOT * * * 
            ...
            plt.title(f'{self.saveName0} - Calculated Portfolio Optimization based on Efficient Frontier', fontsize=30, fontweight='bold')
            plt.xlabel('annualised volatility', fontsize=20, fontweight='bold')
            plt.ylabel('annualised returns', fontsize=20, fontweight='bold')
            for label in (ax.get_xticklabels() + ax.get_yticklabels()):
                label.set_fontsize(15)
...
# #* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
        ...
        # PLOT * * * 
            ...
            ax.set_title(f'{self.saveName0} - Portfolio Optimization with Individual Stocks', fontsize=30, fontweight='bold')
