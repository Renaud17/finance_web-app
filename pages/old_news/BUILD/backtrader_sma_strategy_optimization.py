...
# download data
data = bt.feeds.YahooFinanceData(dataname='AAPL', fromdate=datetime(2018, 1, 1), todate=datetime(2021, 3, 31))
...
cerebro.optstrategy(SmaStrategy, ma_period=range(2, 100))
